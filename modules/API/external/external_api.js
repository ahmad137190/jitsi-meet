...
export default class JitsiMeetExternalAPI extends EventEmitter {
    /**
     * Constructs new API instance. Creates iframe and loads Satia Meet in it.
     *
     * @param {string} domain - The domain name of the server that hosts the
     * conference.
    ...
    /**
     * Getter for the large video element in Satia Meet.
     *
    ...
    /**
     * Getter for the prejoin video element in Satia Meet.
     *
    ...
    /**
     * Getter for participant specific video element in Satia Meet.
     *
     ...
     * {@code readyToClose} - all hangup operations are completed and Satia Meet
    ...
    /**
     * Removes the listeners and removes the Satia Meet frame.
     *
     * @returns {void}
     */
    dispose() {
    ...
    /**
     * Returns the iframe that loads Satia Meet.
     *
     ...
     * Only applies to certain Satia Meet deploys.
