...
/**
 * Restores a Satia Meet config.js from {@code localStorage} if it was
 ...
 * @returns {?Object} The Satia Meet config.js which was previously downloaded
...
export function setConfigFromURLParams(
    ...
    //     "interfaceConfig.APP_NAME": "Satia Meet"
    // }
    // We want to have:
    // json = {
    //     config: {
